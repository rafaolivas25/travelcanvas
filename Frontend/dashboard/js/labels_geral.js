    ...
    function getEst() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                var total_4 = 0;
                console.log(result);
                let tabela = document.querySelector("#labels_geral")
                let html = ``
                ...
                window.localStorage.setItem("labels_total", total);
                window.localStorage.setItem("labels_bucket", total_1);
                window.localStorage.setItem("labels_visited", total_2);
                window.localStorage.setItem("labels_lived", total_3);
                window.localStorage.setItem("labels_fav", total_4);
